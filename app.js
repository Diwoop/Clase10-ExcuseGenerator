let opcionesQuien = ['El perro', 'Mi gato', 'Mi abuela', 'El repartidor', 'Mi madre'];
let opcionesAccion = ['se ha comido','se ha meado en','ha roto', 'se ha llevado'];
let opcionesQue = ['mis deberes', 'mi movil', 'mi coche', 'mis llaves'];
let opcionesCuando = ['antes de clase', 'mientras yo dormia', 'mientras estaba en el gimnasio', 'cuando estaba rezando'];
